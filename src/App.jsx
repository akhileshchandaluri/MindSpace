...
function App() {
    ...
    const initAuth = async () => {
      try {
        ...
        if (session?.user) {
          ...
          // Auto-enable encryption for this user
          await enableEncryption(session.user.id)
          console.log('🔐 Auto-encryption enabled on app load')
  ...
  const handleLogout = async () => {
    ...
    sessionStorage.clear() // Clear all session data including encryption key
  }
